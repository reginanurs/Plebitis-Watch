...
function DataPivcPage() {
  ...
  return (
    <div>
      <PageHeader
        title="Data PIVC"
        description="Pilih pasien untuk mengelola data pemasangan dan pemantauan PIVC."
      ...
      <PatientPicker
        ...
        onSelect={(patient) => navigate(`/pivc/${patient.id}`)}
      />
    </div>
  )
}

export default DataPivcPage
